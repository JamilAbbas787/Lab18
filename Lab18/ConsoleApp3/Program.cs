...
namespace ConsoleApp3
{
	...
	// James -- hey Jamil, I would put this in it's own file to keep your code more organized. 
	// James -- I would also test these methods to make sure they are working.  so far they look fine but I don't 
	// see any proof of testing.
	public static class LinkedList
	{
		...
		// JAmes - I like that you are using generics here, good stuff. 
